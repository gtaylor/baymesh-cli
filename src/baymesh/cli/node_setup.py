...
def run_setup_wizard() -> "ConfigsToApply":
    wizard = SetupWizard()
    return wizard.run()
...
class SetupWizard(object):
    ...
    def set_prompt_func(self, next):
        self._current_prompt = next
    ...
    def _prompt_lora_preset(self):
        ...
        self.set_prompt_func(self._prompt_long_name)
    ...
    def _prompt_long_name(self):
        ...
        # TODO: Validate long_name
        self._settings.device_long_name = long_name
        self.set_prompt_func(self._prompt_short_name)
    ...
    def _prompt_short_name(self):
        ...
        self.set_prompt_func(self._prompt_device_role)
    ...
    def _prompt_device_role(self):
        ...
        self.set_prompt_func(self._prompt_confirm_settings)
...
def apply_configs(
    ...
    echo.set_logging_level(logging.WARNING)
